  ...
  return (
       <Box p={["30px 20px","30px"]}>
            ...
            <Box className="typing-slider">
                ...
                <p>iBuild server side applications</p>
                <p>iDevelop cool applications.</p>
            </Box>
            <Text fontSize={[10, 12, 14]} textAlign={["left","center"]} color="grey" >FullStack Developer | Women in Tech Advocate | Software Engineer</Text>
